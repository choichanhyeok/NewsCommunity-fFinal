...
const listing = () => {
    ...
    $.ajax({
        type: 'GET',
        url: 'localhost:4943/news', // 테스트용 url
//        url: 'http://awseb-AWSEB-1ILGAF6SPC5CX-485819853.ap-northeast-2.elb.amazonaws.com/news', // S3, cloudFront 배포용 url
        data: {},
                ...
                let html_data = `<div class="col">
                                        <div class="card h-100">
                                            <img class="card-image-box" src=${image_url}
                                                 class="card-img-top">
                                            <div class="card-body">
                                                <a href="/detail.html/${post_id}"><h5 class="card-title">${title}</h5></a>
